...
const Jane = {
  ...
  state: 'Abuja',
  avatar: 'https://images.pexels.com/photos/2101841/pexels-photo-2101841.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'
}
const Kudi = {
  id: 3,
  name: 'Kid Kudi',
...
export const chats = [
  {
    ...
    name: 'Jane doe',
    type: ChatType.user,
    chatImg: 'https://images.pexels.com/photos/2101841/pexels-photo-2101841.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    messages: [{
      id: 1,
      time: 1596113971879,
...

  {
    ...
    name: 'Kid kudi',
    type: ChatType.user,
    chatImg: 'https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    messages: [{
      id: 1,
      time: 1595968036000,
  ...
  },
  {
    ...
    name: 'Golang',
    type: ChatType.group,
    chatImg: 'https://res.cloudinary.com/practicaldev/image/fetch/s--ArkVTP_p--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://cl.ly/e01e310f132c/Image%25202019-09-30%2520at%25206.27.51%2520PM.png',
    messages: [{
      id: 1,
      time: 1596113971879,
